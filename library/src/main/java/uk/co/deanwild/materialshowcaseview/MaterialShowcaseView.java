...
public class MaterialShowcaseView extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    private OnClickSkipListener onClickSkipListener;
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.tv_dismiss)
            ...
            onClickSkipListener.onCLickSkip();
    }
    ...
    public void setSkipText(CharSequence dismissText) {
        if (mSkipButton != null) {
            mSkipButton.setText(dismissText);
        }
    }
